...
<body>
	...
	<div id="div_root">
		...
		<div id="section1">
			...
			<form action="FreeBoard_Update.do" method="post" enctype="multipart/form-data">
			<input type="hidden" name="cNum" value="${fbContent.FBN_seq}">
			<input type="hidden" name="fNameOri" value="${fbContent.imgName}">
			...
			<table border="0" width="90%">
				...
				<tr>
					...
					<td style="text-align: left;">
						<input type="text" name="contentTitle" maxlength="50"
								value="${fbContent.title}" class="form-control" id="inputDefault">
					</td>
				</tr>
				<tr>
					<td height="45" style="text-align: left; font-weight: bold;">
					...
					<td style="text-align: left;">
						<input type="password" name="contentPW" maxlength="8"
								value="${fbContent.contentPW}" class="form-control" id="inputDefault">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="text-align: left;">
						<c:choose>
							<c:when test="${not empty fbContent.imgName}">
								<p id="fileName">${fbContent.imgName}
				...
				<tr>
					<td colspan="2" height="420" style="text-align: left; margin-top: 40px;">
						<textarea name="content" maxlength="1200" class="form-control" id="exampleTextarea"
								style="width: 100%; height: 400px; resize: none; border: solid 2px; ">${fbContent.content}</textarea>
					</td>
				</tr>
			</table>
			...
			<input type="button" value="취소" onclick="return_List();" class="btn btn-danger" style="font-size: 13pt; font-weight: bold;">
			</form>
