...
<body>
	...
	<div id="div_root">
		...
		<div id="section1">
			...
			<form action="ClubBoard_Update.do" method="post" enctype="multipart/form-data">
			<input type="hidden" name="cNum" value="${cbContent.CBN_seq}">
			<input type="hidden" name="fNameOri" value="${cbContent.imgName}">
			...
			<table border="0" width="90%">
				...
				<tr>
					...
					<td style="text-align: left;">
						<input type="text" name="contentTitle" maxlength="50"
								value="${cbContent.title}" class="form-control" id="inputDefault">
					</td>
				</tr>
				<tr>
					<td height="45" style="text-align: left; font-weight: bold;">
					...
					<td style="text-align: left;">
						<input type="password" name="contentPW" maxlength="8"
								value="${cbContent.contentPW}" class="form-control" id="inputDefault">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="text-align: left;">
						<c:choose>
							<c:when test="${not empty cbContent.imgName}">
								<p id="fileName">${cbContent.imgName}
				...
				<tr>
					<td colspan="2" height="420" style="text-align: left; margin-top: 40px;">
						<textarea name="content" maxlength="1200" class="form-control" id="exampleTextarea"
								style="width: 100%; height: 400px; resize: none; border: solid 2px; ">${cbContent.content}</textarea>
					</td>
				</tr>
			</table>
