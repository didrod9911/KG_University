...
<body>
	...
	<div id="div_root">
		...
		<div id="section1">
			...
			<form action="InfoBoard_Update.do" method="post" enctype="multipart/form-data">
			<input type="hidden" name="cNum" value="${ibContent.IBN_seq}">
			<input type="hidden" name="fNameOri" value="${ibContent.imgName}">
			...
			<table border="0" width="90%">
				<tr style="margin-top: 10px;">
					...
					<td style="text-align: left;">
						<select id="contentType" name="contentType" class="form-control" style="width: 200px;">
							...
							<option value="chi">취업</option>
							<option value="jil">질문</option>
							<option value="ect">기타</option>
						</select>
						<script>
							$(document).ready(function(){
								var type = '${ibContent.type}';
				...
				<tr>
					...
					<td style="text-align: left;">
						<input type="text" name="contentTitle" maxlength="50"
								value="${ibContent.title}" class="form-control" id="inputDefault">
					</td>
				</tr>
				<tr>
					<td height="45" style="text-align: left; font-weight: bold;">
					...
					<td style="text-align: left;">
						<input type="password" name="contentPW" maxlength="8"
								value="${ibContent.contentPW}" class="form-control" id="inputDefault">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="text-align: left;">
						<c:choose>
							<c:when test="${not empty ibContent.imgName}">
								<p id="fileName">${ibContent.imgName}
				...
				<tr>
					<td colspan="2" height="420" style="text-align: left; margin-top: 40px;">
						<textarea name="content" maxlength="1200" class="form-control" id="exampleTextarea"
								style="width: 100%; height: 400px; resize: none; border: solid 2px; ">${ibContent.content}</textarea>
					</td>
				</tr>
			</table>
	...
	<script>
		function return_List(){
			if(confirm("정말로 나가시겠습니까?\n작성중이던 내용은 삭제됩니다")){
				location.href="InfoBoard_List.do"
			}
		};
	</script>
